package br.unicamp.ft.a166348.navigationdraweraula.adapter;
...
import br.unicamp.ft.a166348.navigationdraweraula.R;
...
public class ProductItemMenuAdapter extends RecyclerView.Adapter<ProductItemMenuAdapter.ViewHolder>{
    ...
    * Variável para poder selecionar uma das linhas da listas.
    ...
    private final RestaurantMenu products;
    private final OnItemClickListener listener;

    public ProductItemMenuAdapter(RestaurantMenu restautantMenu, OnItemClickListener listener) {
