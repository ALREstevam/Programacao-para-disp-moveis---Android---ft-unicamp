...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //this.frag2 = (BlankFragment) frgMngr.findFragmentById( R.id.dynamic_fragment);
        ...
        replaceFragment( "INIT", new BlankFragment(), "empty" );
    ...
    * */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Fragment mailFragment = frgMngr.findFragmentByTag( "mail" );

            if (mailFragment == null) {
                mailFragment = new MailFragment();
            }

            replaceFragment( "1", new MailFragment(), "mail" );


        } else if (id == R.id.nav_gallery) {
            replaceFragment( "2", new BlankFragment(), "empty" );
